    ...
    <transition name="scale-in-center">
        <div id="profile-page">
            <router-link :to="{ name: 'cafes' }">
                <img src="/storage/close-modal.svg" id="back"/>
            </router-link>
            ...
            <div class="grid-container">
                ...
                <div  id="profile-updated-successfully" class="profile-updated-successfully" style="display: none">
                    <span>用户信息更新成功！</span>
                </div>
            </div>
